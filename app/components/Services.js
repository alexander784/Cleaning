...
export default function Services() {
    return (
      <section id="services" className="py-16 flex items-center justify-center min-h-screen bg-gray-200">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
            <BuildingOffice2Icon className="h-12 w-12 mx-auto mb-4 text-blue-600" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
            <SparklesIcon className="h-12 w-12 mx-auto mb-4 text-blue-600" />
